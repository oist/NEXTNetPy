...
std::tuple<std::vector<double>, std::vector<int>> simulate_single_trajectory(py::object network,transmission_time& psi, transmission_time* rho, bool SIR,double TMAX, bool EDGES_CONCURRENT,int INITIAL_INFECTED, int seed);


std::vector<std::tuple<double, int, int, int>> simulate(py::object network,transmission_time& psi, transmission_time* rho, bool SIR,double TMAX, bool EDGES_CONCURRENT,int INITIAL_INFECTED, int seed);


//simulate_on_activity_average disabled because it depends on average_trajectories which
...
std::tuple<std::vector<double>, std::vector<double>> simulate_average_trajectory(py::object network,transmission_time& psi, transmission_time* rho, bool SIR,double TMAX, bool EDGES_CONCURRENT,int INITIAL_INFECTED, int seed, int NB_SIMULATIONS, bool TRIM,bool VERBOSE, bool ALL_NODES);
